...
# creating object for config class and defining parameters(image_height, image_width, learning rate, iterations, num_classes, images per batch)
ob1 = config(95, 95, 0.00025, 100, 1, 2) 
